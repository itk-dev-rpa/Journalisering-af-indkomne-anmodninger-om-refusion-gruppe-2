...
- Fixed timezone error on task deadlines.

## [2.3.0] - 2025-12-10

### Changed

- Deadlines on existing Nova task are no longer moved forward in time.
...
[2.3.0]: https://github.com/itk-dev-rpa/Journalisering-af-indkomne-anmodninger-om-refusion-gruppe-2/releases/tag/2.3.0
[2.2.0]: https://github.com/itk-dev-rpa/Journalisering-af-indkomne-anmodninger-om-refusion-gruppe-2/releases/tag/2.2.0
